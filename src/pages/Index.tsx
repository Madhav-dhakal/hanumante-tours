...
const Index = () => {
  return (
    <div className="min-h-screen bg-background" id="top">
      ...
      <section id="plan-trip" className="py-20 bg-primary">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
      ...
      {/* Book Now Section */}
      <section id="book-now" className="py-20 bg-sacred-gold">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 text-white">
              <Badge className="mb-4 bg-white/20 text-white">
              ...
              <h2 className="text-4xl font-bold mb-6">Book Your Adventure Today</h2>
              <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
                <h3 className="text-2xl font-bold text-white mb-6">Quick Booking Steps</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="text-white">
                      ...
                      <p className="text-white/80 text-sm">Select from our curated tours or request a custom package</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="text-white">
                      <h4 className="font-semibold mb-1">Secure Your Dates</h4>
                      <p className="text-white/80 text-sm">Reserve your preferred travel dates with a small deposit</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="text-white">
                      <h4 className="font-semibold mb-1">Prepare & Depart</h4>
                      <p className="text-white/80 text-sm">Get your travel documents ready and start your adventure</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
                <h3 className="text-2xl font-bold text-white mb-6">Booking Benefits</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-white">Travel Insurance Included</span>
                  </div>
                  <div className="flex items-center space-x-3">
            ...
            <div className="text-center">
              <Button className="bg-white text-sacred-gold hover:bg-white/90" size="lg">
